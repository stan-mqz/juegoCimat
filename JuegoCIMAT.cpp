...
int main()
{
    ...
    if (dificultad == 1)
    {
        ...
        while (true)
        {
            ...
            } // if que define el numero de la pregunta
            else
            {
    ...
    if (dificultad == 2)
    {
        ...
        while (true)
        {
            ...
            if (pregunta > 0)
            {
                ...
                case 19:
                    cout << "Lisa recibio un cheque regalo de 100 euros por su cumpleanos. Se compro unas deportivas que costaban 30 euros, un vestido de 23 euros y dos libros de 17 euros. Cuanto dinero le quedo en el cheque regalo?" << "\n";
                    cin.ignore();
                    cin.get();
                ...
                case 20:
                    cout << "Si David tiene el doble de monedas de 5 centimos que Tomas y Tomas tiene 15 monedas de 5 centimos mas que Juan, cuantas monedas tiene David si Juan tiene 6 monedas de cinco centimos?" << "\n";
                    cin.ignore();
                    cin.get();
